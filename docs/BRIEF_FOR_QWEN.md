...
- **Подтверждение даты и места:** под полем даты показывается «Выбрано: 15 марта 1990 г.»; под местом — «Место рождения: …»; галочка «Подтверждаю: место рождения указано верно» (обязательна для перехода дальше).
