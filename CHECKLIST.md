...
- **Рекомендации:**
  1. Либо синхронизировать `public/index.html` с корневым `index.html`, либо явно указать в README, что для Mini App используется только корневой `index.html` (деплой идёт из корня).
